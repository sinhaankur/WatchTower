    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 py-6 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-semibold text-gray-900">Node Management</h1>
            <p className="text-sm text-gray-500 mt-0.5">
              {loading ? 'Loading organization…' : orgName ? `Organization: ${orgName}` : offlineMode ? 'Server offline — some features unavailable' : 'Ready'}
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <Link to="/">
              <Button variant="outline" className="rounded-none border-gray-300 text-sm">← Dashboard</Button>
            </Link>
          </div>
        </div>
      </header>
